...
console.log('chineseFood',chineseFood);
...
console.log(`idol3를 기준으로 idol1, idol2 배열을 concat(spread): ${[...idol3, ...idol1, ...idol2]}`);

// slice(선택 요소 복사) / splice(선택한 인덱스 위치 요소 제거 및 추가)
const front = ['HTML', 'CSS', 'JavaScript', 'Vue'];

console.log(`front.slice(): ${front.slice(1, 3)}`); // 1 ~ 2 인덱스까지 복시
console.log(`front: ${front}`);

console.log(`front.splice(); ${front.splice(2, 2, 'JDBC')}`);   // 2번 인덱스부터 이후 2개를 제거하고 추가
console.log(`front: ${front}`);
